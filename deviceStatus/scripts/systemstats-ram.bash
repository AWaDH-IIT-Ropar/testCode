...
function get_cpu () {
    ...
    local TMP=$(echo "($CPU_USAGE_A53_0 + $CPU_USAGE_A53_1 + $CPU_USAGE_A53_2 + $CPU_USAGE_A53_3 + $CPU_USAGE_A72_0 + $CPU_USAGE_A72_1) / 6" | bc -l)
    CPU_USAGE=$TMP
    echo "$(python3 -c "import psutil; print(psutil.cpu_percent())")"
} # not done
